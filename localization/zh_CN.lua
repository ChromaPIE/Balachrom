return {
    descriptions = {
        Joker = {
            ...
            j_faceless = {
                ...
                text = {
                    "如果同时弃掉",
                    "大于等于{C:attention}#2#{}张{C:attention}人头牌",
                    "获得{C:money}$#1#{}"
                }
            },
            j_green_joker = {
        ...
        Voucher = {
            ...
            v_tarot_tycoon = {
                ...
                unlock = {
                    "在商店中购买",
                    "总计{C:attention}#1#{}张{C:tarot}塔罗牌",
                    "{C:inactive}(#2#)"
                }
            },
            v_planet_tycoon = {
                ...
                unlock = {
                    "在商店中购买",
                    "总计{C:attention}#1#{}张{C:planet}星球牌{}",
                    "{C:inactive}(#2#)"
                }
            },
            v_glow_up = {
    ...
    misc = {
        ...
        dictionary = {
            ...
            ph_deck_preview_effective = "受小丑、盲注和卡牌强化影响而导致的有效总数",
            ...
            ph_stat_voucher = "兑换此奖券的次数",
            ph_demo_thanks_1 = "感谢游玩",
            ph_demo_thanks_2 = "BALATRO 演示版",
            ph_game_over = "游戏结束",
            ph_vouchers_redeemed = "本赛局兑换的奖券",
            ph_no_vouchers = "本赛局并未兑换任何奖券",
        ...
        v_text = {
            ...
            ch_c_debuff_played_cards = {
                "所有{C:attention}打出{}的牌在计分后都会{C:attention}失效"
            },
            ch_c_set_eternal_ante = {
                "当底注{C:attention}#1#{}的Boss盲注被击败时，所有小丑牌变为{C:attention}永恒"
            },
        ...
        tutorial = {
            ...
            s_9 = {
                "如果你攒够了钱，",
                "还可以购买{C:attention}奖券{}。",
                "{C:attention}奖券{}是在一局游戏里",
                "被动强化你的物品！"
            },
            s_10 = {
                "只要你打败",
                "{C:attention}Boss盲注{}，",
                "{C:attention}奖券{}就会补货上架。"
            },
            s_11 = {
                "然后来看看这两个",
                "所有商店都会有的",
