--- STEAMODDED HEADER
--- MOD_NAME: Fusion Jokers 2
--- MOD_ID: FusionJokers_2
...
local FusionJokers_2 = {}
FusionJokers_2.fusions = {
	{ jokers = {
...
function SMODS.INIT.FusionJokers_2()
    ...
    if SMODS.INIT.FusionJokers then
        ...
        for _, fusion in ipairs(FusionJokers_2.fusions) do
